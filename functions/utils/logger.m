classdef (ConstructOnLoad = false) logger < handle
    ...
    %
    %
    % This function was originally developed by https://github.com/ismet55555/Logging-For-MATLAB
    ...
    methods
        ...
        % This method runs when the object is being created into memory
            ...
            obj.object_creation_file     = string(caller_stack(1).file);
            obj.object_creation_function = string(caller_stack(1).name);
